...
// i18n symbols that should be imported from @emcl/ui
...
const VALID_IMPORT_SOURCES = ['@emcl/ui']
...
function main() {
	...
	if (verbose) {
		console.log(theme.muted('  Tip: Import these symbols from @emcl/ui'))
		console.log(theme.muted('  Example: import { useVIntl, defineMessages } from \'@emcl/ui\''))
		console.log()
	}
