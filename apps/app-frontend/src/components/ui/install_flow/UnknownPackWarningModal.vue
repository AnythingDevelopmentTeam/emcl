...
import { CircleArrowRightIcon, SpinnerIcon, XIcon } from '@emcl/assets'
import {
	Admonition,
	ButtonStyled,
	Checkbox,
...
const messages = defineMessages({
	...
	warningBody: {
		...
		defaultMessage: `We couldn't find this file on the platform. We strongly recommend only installing files from sources you trust.`,
	},
	body: {
		id: 'unknown-pack-warning-modal.body',
		defaultMessage: `A file is only reviewed if it\u2019s uploaded to our platform, regardless of its file format (including .mrpack).`,
	},
	malwareStatement: {
