...
export const minecraftAuthErrors: MinecraftAuthError[] = [
	{
		...
		whatHappened:
			'Your saved Microsoft sign-in token has expired or was revoked, so EMCL cannot refresh your Minecraft session.',
		stepsToFix: [
			'Sign out of the affected Minecraft account in EMCL',
	...
	},
	{
		...
		whatHappened:
			"Minecraft's authentication service is returning a server error, so EMCL cannot finish signing you in right now.",
		stepsToFix: [
	...
	},
	{
		...
		stepsToFix: [
			...
			'Make sure you are using the Microsoft account that owns Minecraft. See <a href="https://example.com/support">Finding the right Xbox account</a> for help',
			'Try signing in to EMCL again',
		],
	},
	{
		matches: (message) =>
		...
		whatHappened:
			'EMCL could not connect to a Microsoft, Xbox, or Minecraft service needed for sign-in. This is usually caused by a local network, DNS, proxy, firewall, hosts file, VPN, or antivirus issue.',
		stepsToFix: [
			'Restart EMCL and try signing in again',
			'Check that your internet connection is working',
			'Allow EMCL through your firewall, antivirus, proxy, VPN, and hosts file rules',
	...
	},
	{
		...
		whatHappened:
			'Xbox services rejected the request to authorize this account for Minecraft services, but did not return a specific account restriction that EMCL recognizes.',
		stepsToFix: [
			'Sign in with the <a href="https://www.minecraft.net/en-us/download">official Minecraft Launcher</a>',
