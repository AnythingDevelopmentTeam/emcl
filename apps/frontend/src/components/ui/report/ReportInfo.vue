...
<script setup>
import { ReportIcon, UnknownIcon, VersionIcon } from '@emcl/assets'
import { Avatar, Badge, CopyCode, useFormatDateTime, useRelativeTime } from '@emcl/ui'
import { formatProjectType, renderHighlightedString } from '@emcl/utils'
